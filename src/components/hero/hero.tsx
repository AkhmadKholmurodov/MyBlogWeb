						...
						<Box sx={{ position: 'relative', width: '100%', height: '72vh' }}>
							...
							>
								...
								<Box sx={{ display: 'flex', gap: '20px', marginTop: '20px' }}>
									<Avatar sx={{width: "60px", height: "60px"}} alt={item.author.name} src={item.author.avatar.url} />
									<Box>
...
const data = [
	{
		image: 'https://media.graphassets.com/output=format:jpg/resize=width:140,height:140,fit:crop/VmwiSkTbQkORJdfBrL5O',
